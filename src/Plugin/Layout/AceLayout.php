...
namespace Drupal\d324_ace\Plugin\Layout;
 ...
 */
class AceLayout extends LayoutDefault implements PluginFormInterface {
  ...
  public function processConfigurationForm(array $form_item, FormStateInterface $form_state) {
    ...
    if (isset($component['third_party_settings']['d324_ace'])) {
      $settings = $component['third_party_settings']['d324_ace'];
    }
