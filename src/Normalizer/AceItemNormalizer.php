...
namespace Drupal\d324_ace\Normalizer;

use Drupal\d324_ace\Plugin\Field\FieldType\AceRevisioned;
use Drupal\hal\Normalizer\EntityReferenceItemNormalizer;

/**
 * Defines a class for normalizing D324AceItems.
 */
class AceItemNormalizer extends EntityReferenceItemNormalizer {
   ...
   * @var string
   */
  protected $supportedInterfaceOrClass = AceRevisioned::class;
