...
namespace Drupal\d324_ace_paragraph_behaviors\Form;
 ...
 */
class AceStylesOverviewForm extends ConfigFormBase {
  ...
  public function __construct(StyleDiscoveryInterface $style_discovery) {
    $this->config = $this->config('d324_ace_paragraph_behaviors.settings');
  ...
  protected function getEditableConfigNames() {
    return ['d324_ace_paragraph_behaviors.settings'];
  }
  ...
  public function getFormId() {
    return 'ace_styles_overview_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $grouped_styles = NULL) {
    ...
    $filters = [
      ...
      '#attributes' => [
        ...
        'data-table' => '.d324-ace-paragraph-behaviors-overview-table',
      ],
      '#title' => $this->t('Filter'),
    ];
    $filters['group'] = [
    ...
    $table = [
      ...
      '#sticky' => TRUE,
      '#attributes' => [
        'class' => ['d324-ace-paragraph-behaviors-overview-table'],
      ],
    ];
    ...
    $form['styles'] = $table;
    $form['#attached']['library'] = ['d324_ace_paragraph_behaviors/overview'];
