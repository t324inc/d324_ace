...
class StyleDiscovery implements StyleDiscoveryInterface {
  ...
  public function getStyleOptions($group = '', $access_check = FALSE) {
    ...
    $enabled_styles = $this->configFactory->get('d324_ace_paragraph_behaviors.settings')->get('enabled_styles');
  ...
  public function getStyles() {
    $cache_id = 'd324_ace_paragraph_behaviors_style';
  ...
  public function getStyleGroups() {
    $cache_id = 'd324_ace_paragraph_behaviors_style_group';
  ...
  public function reset() {
    ...
    $this->cache->deleteMultiple(['d324_ace_paragraph_behaviors_style', 'd324_ace_paragraph_behaviors_style_group']);
  }
